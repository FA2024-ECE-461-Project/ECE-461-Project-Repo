...
describe('_handleError', () => {
    ...
    it('should handle invalid or missing GitHUb Token error (401)', async () => {
        ...
        await expect(() => _handleError(error, context)).toThrow('process.exit: 1');
        expect(exitSpy).toHaveBeenCalledWith(1);
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('Error: Unauthorized. Invalid or missing GitHub Token.'));
      ...
      it('should handle invalid URL (404)', async () => {
        ...
        await expect(() => _handleError(error, context)).toThrow('process.exit: 1');
        expect(exitSpy).toHaveBeenCalledWith(1);
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('Error: Not Found. Invalid URL.'));
    ...
    it('should handle between 400 and 500 (406)', async () => {
        ...
        await expect(() => _handleError(error, context)).toThrow('process.exit: 1');
        expect(exitSpy).toHaveBeenCalledWith(1);
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('406'));
    ...
    it('should handle between 500 and 600 (506)', async () => {
        ...
        await expect(() => _handleError(error, context)).toThrow('process.exit: 1');
        expect(exitSpy).toHaveBeenCalledWith(1);
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('506'));
