...
describe('calculateResponsiveness', () => {
  ...
  it('should handle mixed data correctly', () => {
    const metrics: RepoDetails = {
      ...
      issuesData: [
        ...
        { created_at: '2024-08-01T00:00:00Z', state: 'closed', closed_at: '2024-08-02T00:00:00Z' },
        { created_at: '2024-07-01T00:00:00Z', state: 'closed', closed_at: '2024-07-02T00:00:00Z' },
      ],
      contributorsData: [],
    };
  ...
  it('should return a value of 1 when all issues opened and closed yesterday', () => {
    ...
    const metrics: RepoDetails = {
      ...
      issuesData: [
        { created_at: yesterday.toISOString(), state: 'closed', closed_at: yesterday.toISOString() },
        { created_at: yesterday.toISOString(), state: 'closed', closed_at: yesterday.toISOString() },
        { created_at: yesterday.toISOString(), state: 'closed', closed_at: yesterday.toISOString() },
        { created_at: yesterday.toISOString(), state: 'closed', closed_at: yesterday.toISOString() },
        { created_at: yesterday.toISOString(), state: 'closed', closed_at: yesterday.toISOString() },
    ...
    it('should return a value 0-1 for commits and issues 6 months ago', () => {
        ...
        issuesData: [
            { created_at: sixMonthsAgo.toISOString(), state: 'closed', closed_at: sixMonthsAgo.toISOString() },
        ],
        contributorsData: [],
        };
